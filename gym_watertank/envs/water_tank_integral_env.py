...
class WaterTankIntegralEnv(gym.Env):
	...
	def __init__(self, A=np.array([[0.98, 0], 
					   ...
					   seed=None,
					   overflow_cost = -100):
		super(WaterTankIntegralEnv, self).__init__()
...
class WaterTankIntegralEnv1(WaterTankIntegralEnv):
	"""docstring for WaterTankLQIEnv"""
	metadata = {'render.modes': ['human']}
	def __init__(self, A=np.array([[0.98, 0], 
									[0.02, 0.98]]),
					   ...
					   seed=None,
					   overflow_cost = -100):
		super(WaterTankIntegralEnv1, self).__init__()
...
class WaterTankIntegralEnv2(WaterTankIntegralEnv):
	"""docstring for WaterTankLQIEnv"""
	metadata = {'render.modes': ['human']}
	def __init__(self, A=np.array([[0.98, 0], 
									[0.02, 0.98]]),
					   ...
					   seed=None,
					   overflow_cost = -100):
		super(WaterTankIntegralEnv2, self).__init__()
